...
(() => {
  const stylesheet = `
    ...
    .toolbar button:hover { background: rgba(255,255,255,0.09); color: #fff; }
  ...
  class ThreeDStage extends HTMLElement {
    ...
    async _boot() {
      ...
      // Dark vault studio: a procedural equirect environment (two softbox
      // strips over near-black) supplies the controlled reflections metals
      // need, plus one dim shadow-casting key. The module adds the spot.
      ...
      grad.addColorStop(0.44, '#0a0c10');
      grad.addColorStop(1, '#040507');
      g.fillStyle = grad;
      g.fillRect(0, 0, 512, 256);
      g.filter = 'blur(9px)';
      g.fillStyle = 'rgba(255,251,244,0.95)';
      g.fillRect(58, 16, 46, 148);
      g.fillStyle = 'rgba(206,222,244,0.6)';
      g.fillRect(330, 8, 26, 116);
      g.fillStyle = 'rgba(255,255,255,0.35)';
      g.fillRect(-20, -10, 560, 14);
      ...
      scene.add(new THREE.HemisphereLight(0x2a3038, 0x05060a, 0.35));
      const key = new THREE.DirectionalLight(0xdce4f0, 0.5);
      ...
      this._key = key;
      scene.add(key);
      const fill = new THREE.DirectionalLight(0x9fb2cc, 0.18);
